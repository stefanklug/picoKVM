...
std::vector<std::vector<uint32_t>> vncScanToHIDList_de = {
    ...
    {XK_2,          KM_SHIFT | XK_quotedbl      , KM_ALTGR | XK_quotedbl     , KEY_2},
    {XK_3,          KM_SHIFT | XK_section       , KM_ALTGR | XK_section      , KEY_3},
    {XK_4,          KM_SHIFT | XK_dollar        , KM_ALTGR | XK_dollar       , KEY_4},
    {XK_5,          KM_SHIFT | XK_percent       , KM_ALTGR | XK_percent      , KEY_5},
    {XK_6,          KM_SHIFT | XK_ampersand     , KM_ALTGR | XK_ampersand    , KEY_6},
    ...
    {XK_plus,       KM_SHIFT | XK_asterisk                                   , KEY_RIGHTBRACE},
